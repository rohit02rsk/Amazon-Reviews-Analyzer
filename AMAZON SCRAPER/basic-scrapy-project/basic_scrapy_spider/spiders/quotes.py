...
class AmazonReviewsSpider(scrapy.Spider):
    ...
    def start_requests(self):
        amazon_reviews_url = f'https://www.amazon.com/product-reviews/{self.cat}/'
        yield scrapy.Request(url=amazon_reviews_url, callback=self.parse_reviews, meta={'retry_count': 0})
